                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{url('/view_product')}}" class="dropdown-item">Add Products</a>
                            <a href="{{url('/show_product')}}" class="dropdown-item">Show Products</a>
   
                        </div>
                    </div>
                    <a href="wideget" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Widgets</a>
                    <a href="{{url('order')}}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Order </a>
                    ...
                    <a href="{{url('view-catagory')}}" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Catogary</a>
                    <div class="nav-item dropdown">
